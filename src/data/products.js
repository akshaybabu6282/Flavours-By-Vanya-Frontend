export const products = [
  // MASALAS
  {
    ...
    category: 'Masala',
    imageFront: '/public/assets/turmeric-front.jpg',
    imageBack: '/public/assets/turmeric-back.webp',
    imageBg: '/public/assets/turmeric-bg.jpg',
...
Experience the true gold of Wayanad with **Flavours by Vanya Turmeric Powder** where purity meets heritage, and every pack reflects the soul of our land.`,
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'Our turmeric is sourced directly from the organic highlands of Wayanad, where the climate and soil create the perfect balance for nutrient-rich cultivation. Every rhizome is grown without synthetic inputs, ensuring a clean, chemical-free product that meets the highest purity standards. Each batch is carefully tested to maintain consistent quality, freshness, and aroma from farm to final pack.', image: '/public/assets/turmeric-sourcing.webp' },
      { title: 'Processing & Packaging', text: 'The turmeric roots are handpicked at peak maturity, washed, boiled, and sun-dried before being finely ground into powder. We use small-batch grinding to retain natural oils and curcumin content. Each pouch is sealed using food-grade, moisture-proof packaging to preserve freshness, fragrance, and colour delivering the authentic aroma of Wayanad straight to your kitchen.', image: '/public/assets/turmeric-processing.webp' },
      { title: 'Health Benefits', text: 'Turmeric is known for its powerful anti-inflammatory and antioxidant properties, which support overall wellness. Regular use aids digestion, strengthens immunity, and promotes glowing skin. It’s a natural healer that’s been trusted in Ayurvedic medicine for generations a golden spice that balances body, mind, and soul.', image: '/public/assets/turmeric-benefits.webp' }
    ],
    smallImages: ['/public/assets/turmeric-small-1.webp', '/public/assets/turmeric-small-2.webp', '/public/assets/turmeric-small-3.webp', '/public/assets/turmeric-small-4.webp'],
