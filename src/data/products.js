...
Experience the true gold of Wayanad with **Flavours by Vanya Turmeric Powder** where purity meets heritage, and every pack reflects the soul of our land.`,
  ...
  },
  {
    ...
    slug: 'chilli-powder',
    category: 'Masala',
    imageFront: '/assets/chilli-front.webp',
    imageBack: '/assets/chilli-back.webp',
    imageBg: '/assets/chilli-bg.webp',
  ...
  },
  {
    ...
    category: 'Masala',
    imageFront: '/assets/kashmiri-front.webp',
    imageBack: '/assets/kashmiri-back.webp',
    imageBg: '/assets/kashmiri-bg.webp',
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'Our Kashmiri chillies are grown on Wayanad’s organic estates, nourished by fertile soil and pure rainwater. Each batch is carefully tested for colour, flavour, and natural purity, ensuring consistent quality in every pack.', image: '/assets/kashmiri-sourcing.webp' },
      { title: 'Processing & Packaging', text: 'Sun dried and finely ground in small batches, the powder is sealed in premium, moisture proof pouches to retain its vibrant colour, aroma, and freshness.Drying and grinding under hygienic conditions.', image: '/assets/kashmiri-processing.webp' },
      { title: 'Health Benefits', text: 'Rich in antioxidants and vitamins, Kashmiri Chilli Powder supports metabolism, immunity, and digestive health, while adding warmth and colour to meals.', image: '/assets/kashmiri-benefits.webp' }
    ],
  ...
  },
  {
    ...
    slug: 'pepper-powder',
    category: 'Masala',
    imageFront: '/assets/pepper-front.webp',
    imageBack: '/assets/pepper-back.webp',
    imageBg: '/assets/pepper-bg.webp',
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'Grown on Wayanad’s organic estates with chemical free practices, each peppercorn is selected for aroma, flavour, and freshness, ensuring superior quality in every pack.', image: '/assets/pepper-sourcing.webp' },
      { title: 'Processing & Packaging', text: 'Dried naturally and finely ground, the powder is sealed in moisture resistant pouches to retain its aroma, potency, and authentic Wayanad flavour.', image: '/assets/pepper-processing.webp' },
      { title: 'Health Benefits', text: 'Pepper is known for improving digestion, boosting metabolism, and supporting respiratory health, while adding warmth and sharpness to meals.', image: '/assets/pepper-benefits.webp' }
    ],
  ...
  },
  {
    ...
    slug: 'garam-masala',
    category: 'Masala',
    imageFront: '/assets/garam-front.webp',
    imageBack: '/assets/garam-back.webp',
    imageBg: '/assets/garam-bg.webp',
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'All spices in our Garam Masala are organically grown in Wayanad’s fertile highlands, handpicked at peak maturity, and carefully processed to retain aroma, flavour, and purity.', image: '/assets/garam-sourcing.webp' },
      { title: 'Processing & Packaging', text: 'Spices are sun-dried, lightly roasted, and ground in small batches. The powder is sealed in premium, moisture proof pouches to maintain freshness, fragrance, and colour.', image: '/assets/garam-processing.webp' },
      { title: 'Health Benefits', text: 'Garam Masala aids digestion, boosts metabolism, and enhances overall immunity while adding warmth and aroma to meals.', image: '/assets/garam-benefits.webp' }
    ],
  ...
  },
  {
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'All ingredients are organically cultivated in Wayanad’s fertile highlands and handpicked at peak maturity to ensure maximum aroma, colour, and purity.', image: '/assets/fish-masala-sourcing.webp' },
      { title: 'Processing & Packaging', text: 'Spices are sun dried and finely ground in small batches. Each pouch is sealed in moisture proof, premium packaging to preserve freshness and potency.', image: '/assets/fish-masala-processing.webp' },
      { title: 'Health Benefits', text: 'Rich in antioxidants and essential nutrients, Fish Masala enhances digestion, supports immunity, and adds warmth to meals.', image: '/assets/fish-masala-benefits.webp' }
    ],
  ...
  **Flavours by Vanya Cinnamon** embodies the timeless spice tradition of Wayanad pure, aromatic, and naturally wholesome.`,
  ...
  // Nuts & Honey
  {
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'Organically grown in Wayanad, handpicked at full maturity, sun-dried, and processed to maintain freshness, aroma, and natural oils.', image: '/assets/almond-sourcing.jpg' },
      { title: 'Processing & Packaging', text: 'Sun dried, sorted, and packed in premium, moisture proof pouches to retain quality, aroma, and crunch.', image: '/assets/almond-processing.jpg' },
      { title: 'Health Benefits', text: 'Almonds are rich in healthy fats, protein, antioxidants, and vitamins, supporting heart health, brain function, and overall wellness.', image: '/assets/almond-benefits.webp' }
    ],
    smallImages: ['/assets/almond-small-1.webp', '/assets/almond-small-2.jpg', '/assets/almond-small-3.jpg', '/assets/almond-small-4.jpg'],
  ...
  // BEVERAGES
  {
    ...
    descriptionSections: [
      { title: 'Sourcing & Quality', text: 'Handpicked organic tea leaves from Wayanad, blended with natural bergamot essence, maintaining freshness and aroma.', image: '/assets/earl-grey-sourcing.webp' },
