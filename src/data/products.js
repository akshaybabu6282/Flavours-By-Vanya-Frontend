export const products = [
  // MASALAS
  {
    ...
    category: 'Masala',
    imageFront: '/src/assets/turmeric-front.jpg',
    imageBack: '/src/assets/turmeric-back.webp',
    imageBg: '/src/assets/turmeric-bg.jpg',
