export const blogs = [
  {
    ...
    intro:
      "Pepper is more than a spice in Kerala. In Wayanad, it carries the character of the land, the climate, and the traditional farming culture. Its bold aroma and natural heat make it one of the most valued spices from the region.",
    content: [
      {
  ...
  {
    id: 2,
    title: "Cold Pressed Coconut Oil vs Vendha Velichenna",
    slug: "cold-pressed-coconut-oil-vs-vendha-velichenna",
    category: "Coconut Oil",
    image: "/assets/coconut-hot-sourcing.webp",
    excerpt:
      "Understand the difference between cold pressed coconut oil and traditional Kerala Vendha Velichenna.",
    intro:
      "Coconut oil has always been part of Kerala homes, but not all coconut oils are prepared in the same way. Cold pressed coconut oil and Vendha Velichenna both come from coconut, but their preparation, aroma, flavour, and usage experience are different.",
    content: [
      {
      ...
      },
      {
        ...
        image: "/assets/coconut-small-1.webp",
        text: [
          "Choose cold pressed coconut oil if you prefer a lighter, fresh coconut profile. Choose Vendha Velichenna if you love the traditional Kerala aroma and stronger flavour.",
          "At Vanya Eco Products, both oils are presented with care so customers can choose based on their cooking style and personal preference."
        ]
      }
    ]
  },
  {
    ...
    slug: "how-to-store-spices-for-maximum-freshness",
    category: "Storage Tips",
    image: "/assets/garam-bg.webp",
    excerpt:
      "Simple storage tips to keep your spices fresh, aromatic, and flavourful for a longer time.",
    intro:
      "Pure spices need proper care after opening. Since natural spices do not depend on artificial preservatives, the way you store them plays an important role in preserving aroma, colour, and flavour.",
    content: [
      {
      ...
      {
        heading: "Avoid direct sunlight and heat",
        image: "/assets/turmeric-small-1.webp",
        text: [
          "Sunlight and heat can reduce the natural oils present in spices. These oils are responsible for aroma and flavour.",
          "Always store spices in a cool, dry place, preferably inside a closed kitchen cabinet."
        ]
      },
      {
      ...
      {
        heading: "Why zip lock pouches help",
        image: "/assets/pepper-small-1.webp",
        text: [
          "Zip lock pouches help reduce air and moisture exposure when closed properly after every use.",
          "For best results, press out excess air, close the zip lock tightly, and keep the pouch in a dry place."
        ]
      }
    ]
  },
  {
    id: 4,
    title: "Why Freshly Ground Masalas Taste Better",
    slug: "why-freshly-ground-masalas-taste-better",
    category: "Masalas",
    image: "/assets/chilli-bg.webp",
    excerpt:
      "Learn why small batch grinding helps preserve aroma, natural oils, and authentic flavour in masalas.",
    intro:
      "The difference between ordinary masala and freshly ground masala can be felt the moment it touches hot oil or curry. Fresh grinding helps preserve the natural aroma and flavour that make food taste more alive.",
    content: [
      {
      ...
      {
        heading: "The Vanya promise",
        image: "/assets/biriyani-masala-bg.webp",
        text: [
          "Vanya Eco Products focuses on natural ingredients, careful sourcing, and small batch processing.",
          "Our aim is to keep masalas close to their original aroma and traditional taste."
        ]
      }
    ]
  },
  {
    id: 5,
    title: "Why Vanya Does Not Sell Through Supermarkets",
    slug: "why-vanya-does-not-sell-through-supermarkets",
    category: "Brand Story",
    image: "/assets/hero.webp",
    excerpt:
      "Our direct selling approach helps us protect freshness, product handling, and customer trust.",
    intro:
      "At Vanya Eco Products, our selling model is built around freshness, trust, and direct customer connection. We choose not to depend mainly on supermarkets or large online marketplaces because our priority is product quality and relationship, not only shelf presence.",
    content: [
      {
    ...
    intro:
      "Cardamom is one of Kerala’s most treasured spices. In Wayanad, the cool climate and rich soil help produce cardamom with deep aroma, natural sweetness, and vibrant flavour.",
    content: [
      {
        heading: "The climate behind the aroma",
        image: "/assets/cardamom-plantation.jpg",
        text: [
          "Cardamom grows best in cool, shaded, and humid conditions. Wayanad’s natural environment supports this perfectly.",
          "This climate helps cardamom pods develop their signature fragrance and flavour naturally."
        ]
      },
      {
        heading: "Why freshness matters in cardamom",
        image: "/assets/cardamom-sourcing.webp",
        text: [
          "Fresh cardamom retains stronger aroma and flavour compared to old stock stored for long periods.",
          "Proper storage and careful handling help preserve the natural oils inside the pods."
        ]
      },
      {
  ...
  {
    id: 7,
    title: "Why Kashmiri Chilli Powder Is Used For Colour",
    slug: "why-kashmiri-chilli-powder-is-used-for-colour",
    category: "Masalas",
    image: "/assets/kashmiri-bg.webp",
    excerpt:
      "Learn why Kashmiri chilli powder is loved for its rich red colour and balanced heat.",
    intro:
      "Kashmiri chilli powder is popular not only for flavour but also for the vibrant red colour it brings to food. It helps dishes look rich and appetizing without excessive spiciness.",
    content: [
      {
        heading: "The beauty of natural red colour",
        image: "/assets/kashmiri-small-1.webp",
        text: [
          "Kashmiri chilli is known for its bright natural red appearance.",
          "This colour helps curries, gravies, and masalas look more vibrant and appealing."
        ]
      },
      {
        heading: "Balanced heat and flavour",
        image: "/assets/kashmiri-small-2.webp",
        text: [
          "Unlike extremely spicy chilli powders, Kashmiri chilli provides moderate heat with smoother flavour.",
          "This balance makes it suitable for many traditional Indian dishes."
        ]
      },
      {
      ...
      {
        heading: "Freshness makes the difference",
        image: "/assets/kashmiri-bg.webp",
        text: [
          "Freshly processed chilli powder usually has better colour and aroma.",
          "Proper storage also helps preserve its natural richness over time."
        ]
      }
    ]
  },
  {
    ...
    intro:
      "Kerala cooking is deeply connected with spices and masalas. From simple curries to festive dishes, masalas help create warmth, balance, and rich flavour in everyday meals.",
    content: [
      {
      ...
      {
        heading: "Different masalas for different dishes",
        image: "/assets/chicken-masala-bg.webp",
        text: [
          "Kerala cooking uses different masalas depending on the recipe.",
          "Sambar powder, rasam powder, chicken masala, and fish masala all have unique flavour profiles."
        ]
      },
      {
        heading: "Fresh grinding changes everything",
        image: "/assets/biriyani-masala-bg.webp",
        text: [
          "Fresh grinding helps preserve natural oils and aroma in spices.",
          "This is one reason freshly prepared masalas often feel richer and more flavourful."
        ]
      },
      {
  ...
  },
  {
    ...
    intro:
      "The way spices are processed can strongly affect aroma, flavour, and freshness. Small batch processing focuses on quality, handling, and freshness rather than only large scale production.",
    content: [
      {
      ...
      {
        heading: "Better control over quality",
        image: "/assets/chilli-small-1.webp",
        text: [
          "Small batch handling allows more attention to cleaning, grinding, and packing.",
          "This helps maintain consistency and reduces unnecessary handling."
        ]
      },
      {
        heading: "Natural aroma stays stronger",
        image: "/assets/pepper-small-1.webp",
        text: [
          "Freshly processed spices usually retain more of their natural oils and aroma.",
          "This creates stronger flavour when used in cooking."
        ]
      },
      {
        heading: "The Vanya philosophy",
        image: "/assets/hero.webp",
        text: [
          "At Vanya Eco Products, small batch processing is part of our effort to preserve authenticity and freshness.",
          "Our goal is to keep products as close to nature as possible."
        ]
      }
    ]
  },
  {
    ...
    intro:
      "Coconut oil is widely used in Kerala homes for cooking and traditional practices. Choosing pure coconut oil is important because aroma, freshness, and processing quality can vary greatly.",
    content: [
      {
      ...
      {
        heading: "Processing method matters",
        image: "/assets/coconut-hot.webp",
        text: [
          "Cold pressed and traditional hot processed oils both have their own characteristics.",
          "Understanding the preparation method helps you choose the right oil for your preference."
        ]
      },
      {
